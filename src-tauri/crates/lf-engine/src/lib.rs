...
//! # Not built yet
//!
//! Stage 3's bass and drum kit and the PitchShift; wiring the synths, the FX chain, the reverb bus and
//! the limiter into [`engine`] (each is ported in [`dsp`] and tested alone); the device owner
