// fs-audio-settings-verify.mjs — deterministic guard for src/audio/audio-settings.ts persistence validators.
//
...
// localStorage shim installed before the first call is enough to exercise it. Run: node fs-audio-settings-verify.mjs
//
