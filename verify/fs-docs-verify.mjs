// fs-docs-verify.mjs — docs drift guard: every backtick path in a tracked .md exists, every cited
...
if (shallow) {
  console.log('fs-docs: shallow clone — commit-sha check skipped');
...
console.log(`fs-docs: ${mdFiles.length} tracked .md, ${shaCites.size} shas, ${stops.length}/${RIG_LAP_STOP_CAP} rig-lap stops`);
