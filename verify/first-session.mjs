/** Fresh-profile journey through actual controls and downloaded files. Browser tier only.
 * State changes use buttons/keys/file input; __lf only observes audio and recovery.
 */
...
try {
  ...
  await page.getByRole('button', { name: 'Fixed-length record off', exact: true }).click();
